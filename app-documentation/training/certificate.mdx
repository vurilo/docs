...
description: "Configure certificate generation and issuance in vurilo to recognize participants' completion of training programs."
---

### Certificate Generation Setup Guide

Ensure participants receive recognition for completing training programs by configuring certificate generation in vurilo. Follow these steps to set up the certificate generation process within the training section:

1. **Access Training Settings:**
   - Log in to your vurilo account with administrative privileges.
...
By following these steps, you can seamlessly integrate certificate generation into your training programs in vurilo, providing participants with tangible recognition of their accomplishments and motivating them to engage actively in the learning process.
