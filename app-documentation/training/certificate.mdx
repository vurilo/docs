...
description: "Configure certificate generation and issuance in Academy Kit to recognize participants' completion of training programs."
---

### Certificate Generation Setup Guide

Ensure participants receive recognition for completing training programs by configuring certificate generation in Academy Kit. Follow these steps to set up the certificate generation process within the training section:
